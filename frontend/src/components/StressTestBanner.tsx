    ...
    <div className="glass rounded-2xl p-5 relative overflow-hidden group hover:glass-strong transition-all duration-500 cursor-pointer">
      ...
      <div className="relative flex items-center justify-between gap-4">
        <div>
          ...
          <Button className="glow-button rounded-xl bg-gradient-to-r from-primary to-accent text-primary-foreground font-semibold text-xs px-4 hover:opacity-90 transition-all duration-300 group-hover:translate-x-1 gap-2">
            Run FDT
            <ArrowRight size={14} className="transition-transform group-hover:translate-x-1" />
          </Button>
        </div>
        <div className="flex h-16 w-16 rounded-2xl bg-gradient-to-br from-primary/20 to-accent/20 items-center justify-center">
