      ...
      <AreaChart data={performanceData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
        <defs>
          <linearGradient id="glowFill" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="hsl(252, 90%, 60%)" stopOpacity={0.4} />
            <stop offset="50%" stopColor="hsl(280, 80%, 65%)" stopOpacity={0.15} />
            <stop offset="100%" stopColor="hsl(280, 80%, 65%)" stopOpacity={0} />
          </linearGradient>
          <linearGradient id="lineGradient" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="hsl(252, 90%, 60%)" />
        ...
        <Area
          ...
          filter="url(#glow)"
          dot={false}
          activeDot={{ r: 5, fill: "hsl(252, 90%, 60%)", stroke: "white", strokeWidth: 2 }}
        />
      </AreaChart>
    </ResponsiveContainer>
  </div>
    ...
    <ResponsiveContainer width="100%" height={200}>
      <LineChart data={lossData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
        ...
        <Line
          ...
          name="Impact"
          dot={false}
          activeDot={{ r: 4, fill: "hsl(280, 80%, 65%)", stroke: "white", strokeWidth: 2 }}
        />
      </LineChart>
    </ResponsiveContainer>
  </div>
        ...
        <div className="glass rounded-2xl p-4 sm:p-5 mt-4">
          ...
          <div className="relative">
            <div
              ...
              style={{
                width: `${risk[0]}%`,
                background: `linear-gradient(90deg, hsl(252, 90%, 60%), hsl(280, 80%, 65%))`,
                boxShadow: "0 0 12px hsla(252, 90%, 60%, 0.5)",
              }}
            />
            <Slider
              value={risk}
